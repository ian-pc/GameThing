...
//let scoreboard = [window.getItem(0), window.getItem(1), window.getItem(2), window.getItem(3), window.getItem(4)];
   ...
   if (pregame   === 1) {
      ...
      if (paused === 0) {
         ...
         if (timerS === 0 && timerMs <= 1) {
         	...
         	if(level > window.localStorage.getItem(0)) {
         		window.localstorage.setItem(0, level);
         	} else if(level > window.localstorage.getItem(1)) {
         		window.localstorage.setItem(1, level);
         	} else if(level > window.localstorage.getItem(2)) {
         		window.localstorage.setItem(2, level);
         	} else if(level > window.localstorage.getItem(3)) {
         		window.localstorage.setItem(3, level);
         	} else if(level > window.localstorage.getItem(4)) {
         		window.localstorage.setItem(4, level);
         	} 
